---
title: "Comet integrations"
description: "Integrate with Comet using LangChain Python."
---
...
See an [example](/oss/python/integrations/callbacks/comet_tracing).
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/comet_tracking.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
